...
class CHAN_without_GA(nn.Module):
    def __init__(self):
        nn.Module.__init__(self)
        ...
        self.transpose_conv1d_1=t.nn.ConvTranspose1d(2*config.conv2_channel,config.deconv1_channel,kernel_size=4,stride=2,padding=1)
    ...
    def forward(self,batch,seg_len,concept1,concept2):
        ...
        # (batch_size * max_seg_num) * max_seg_length/4 * 512
        attention_result=t.cat((tmp2,self_attention_result),dim=-1)
